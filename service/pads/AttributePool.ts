...
import { NumToAttrib } from '@/types/NumToAttrib';
import { AttributeToNum } from '@/types/AttributeToNum';
...
export class AttributePool {
   ...
   */
  fromJsonable(obj: AttributePool) {
